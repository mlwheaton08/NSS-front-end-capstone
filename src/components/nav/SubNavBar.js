    ...
    return <>
        <section className="subnavbar">
            ...
            <div className="subnav-option">
                ...
                <span className="subnav-text favorites">Favorites</span>
            </div>
            ...
            <div className="subnav-option">
                ...
                <span className="subnav-text read-later">Read Later</span>
            </div>
            ...
            <div className="subnav-option">
                ...
                <span className="subnav-text preferences">Preferences</span>
            </div>
